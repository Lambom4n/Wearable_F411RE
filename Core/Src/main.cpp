...
int main(void)
{
  ...
  // xTaskCreate(LoRa_Task_send, "LoRa_Task_send", 600, nullptr, 1, nullptr);
  xTaskCreate(QuaternionExample_Task, "QuaternionExample", 600, NULL, 1, NULL);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PC13 PC0 PC1 PC2
                           PC3 PC4 PC5 PC6
                           PC7 PC8 PC9 */
  GPIO_InitStruct.Pin = GPIO_PIN_13 | GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9;
